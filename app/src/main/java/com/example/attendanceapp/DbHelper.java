...
class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String STATUS_ID="_STATUS_SID";
    public static final String DATE_KEY="STATUS_DATE";
    public static final String STATUS_KEY="STATUS";
    // Corrected SQL statement for creating the STATUS_TABLE
    private static final String CREATE_STATUS_TABLE = "CREATE TABLE " + STATUS_TABLE_NAME + " (" +
            STATUS_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " +
            S_ID + " INTEGER NOT NULL, " +
            C_ID + " INTEGER NOT NULL, " + // Ensure C_ID is part of the table definition
...
// Change by Tanmay made
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            ...
            db.execSQL(CREATE_STATUS_TABLE); // This could be where your issue is
    ...
    public Cursor getStudentTable(long cid) {
        ...
        try {
            ...
            // Execute the query to get student data based on the class ID
            cursor = database.query(
                    STUDENT_TABLE_NAME,                // Table name
                    null,                              // All columns
                    C_ID + "=?",                       // WHERE clause
                    new String[]{String.valueOf(cid)}, // WHERE arguments
                    null,                              // Group By
                    null,                              // Having
                    STUDENT_ROLL_KEY                   // Order By
            );

        } catch (Exception e) {
            // Log any exceptions that occur
            Log.e("DbHelper", "Error in getStudentTable: " + e.getMessage());
        }

        // It's important not to close the database here because the cursor is still needed
        return cursor;
    }
